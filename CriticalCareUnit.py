...
from untitled import make_group_dist
...
AUDIT_FIRST_OBS = 2 * 24
AUDIT_OBS_INTERVAL =  24
...
class Scenario:
    ...
    def init_sampling(self):
        ...
        self.arrival_dist_elective = make_group_dist(self.seeds[5])
...
class CCU_Patients:
    ...
    def assessment(self):
        """
        Patient process:
        - unplanned: request bed, wait if needed, stay, discharge, bed cleaning for 5hrs
        - planned: if no bed available at arrival, cancel; otherwise admit, stay, discharge,bedcleaning
...
class MonitoredPatient(CCU_Patients):
    '''
    Monitor a Patient.  Inherits from CCU_Patient
...
class WarmupAuditor():
    ...
    def summary_frame(self):
        ...
        df.columns = ['CCU_bed_wait_time', 'bed_util']
